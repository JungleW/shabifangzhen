...
class Goods_EweiShopV2Page extends AppMobilePage
{
	public function get_list()
	{
		...
		$args = array('pagesize' => intval($_GPC['pagesize']), 'page' => intval($_GPC['page']), 'isnew' => trim($_GPC['isnew']), 'ishot' => trim($_GPC['ishot']), 'isrecommand' => trim($_GPC['isrecommand']), 'isdiscount' => trim($_GPC['isdiscount']), 'istime' => trim($_GPC['istime']), 'keywords' => trim($_GPC['keywords']), 'brand' => intval($_GPC['brand']) , 'cate' => intval($_GPC['cate']), 'order' => trim($_GPC['order']), 'by' => trim($_GPC['by']));
		...
		if (0 < $goods['total']) {
			...
			foreach ($goods_list as $index => $item) {
				...
				$goods_list[$index]['memberprice'] = m('goods')->getMemberPrice($goods_list[$index], $level);

				if (!empty($goods_list[$index]['memberprice']) && ($goods_list[$index]['memberprice'] != $goods_list[$index]['minprice']) && !empty($level)) {
					$goods_list[$index]['minprice'] = $goods_list[$index]['memberprice'];
					$goods_list[$index]['memberprice'] = array('levelname' => $level['levelname'], 'price' => $goods_list[$index]['memberprice']);
				}

				unset($goods_list[$index]['uniacid']);
				unset($goods_list[$index]['pcate']);
				unset($goods_list[$index]['ccate']);
				unset($goods_list[$index]['status']);
				unset($goods_list[$index]['displayorder']);
				unset($goods_list[$index]['shorttitle']);
				unset($goods_list[$index]['description']);
				unset($goods_list[$index]['content']);
				unset($goods_list[$index]['goodssn']);
				unset($goods_list[$index]['productsn']);
				unset($goods_list[$index]['productprice']);
				unset($goods_list[$index]['marketprice']);
				unset($goods_list[$index]['costprice']);
				unset($goods_list[$index]['totalcnf']);
				unset($goods_list[$index]['spec']);
				unset($goods_list[$index]['createtime']);
				unset($goods_list[$index]['weight']);
				unset($goods_list[$index]['credit']);
				unset($goods_list[$index]['usermaxbuy']);
				unset($goods_list[$index]['dispatch']);
				unset($goods_list[$index]['thumb_url']);
				unset($goods_list[$index]['isnew']);
				unset($goods_list[$index]['ishot']);
				unset($goods_list[$index]['isrecommand']);
				unset($goods_list[$index]['issendfree']);
				unset($goods_list[$index]['istime']);
				unset($goods_list[$index]['isglobal']);
				unset($goods_list[$index]['iscomment']);
				unset($goods_list[$index]['timestart']);
				unset($goods_list[$index]['timeend']);
				unset($goods_list[$index]['viewcount']);
				unset($goods_list[$index]['deleted']);
				unset($goods_list[$index]['hascommission']);
				unset($goods_list[$index]['commission1_rate']);
				unset($goods_list[$index]['commission1_pay']);
				unset($goods_list[$index]['commission2_rate']);
				unset($goods_list[$index]['commission2_pay']);
				unset($goods_list[$index]['commission3_rate']);
				unset($goods_list[$index]['commission3_pay']);
				unset($goods_list[$index]['score']);
				unset($goods_list[$index]['taobaoid']);
				unset($goods_list[$index]['taobaourl']);
				unset($goods_list[$index]['updatetime']);
				unset($goods_list[$index]['share_title']);
				unset($goods_list[$index]['share_icon']);
				unset($goods_list[$index]['cash']);
				unset($goods_list[$index]['commission_thumb']);
				unset($goods_list[$index]['isnodiscount']);
				unset($goods_list[$index]['showlevels']);
				unset($goods_list[$index]['buylevels']);
				unset($goods_list[$index]['showgroups']);
				unset($goods_list[$index]['buygroups']);
				unset($goods_list[$index]['isverify']);
				unset($goods_list[$index]['storeids']);
				unset($goods_list[$index]['noticeopenid']);
				unset($goods_list[$index]['noticetype']);
				unset($goods_list[$index]['needfollow']);
				unset($goods_list[$index]['followtip']);
				unset($goods_list[$index]['followurl']);
				unset($goods_list[$index]['virtual']);
				unset($goods_list[$index]['ccates']);
				unset($goods_list[$index]['pcates']);
				unset($goods_list[$index]['pcates']);
				unset($goods_list[$index]['discounts']);
				unset($goods_list[$index]['nocommission']);
				unset($goods_list[$index]['hidecommission']);
				unset($goods_list[$index]['artid']);
				unset($goods_list[$index]['detail_logo']);
				unset($goods_list[$index]['detail_shopname']);
				unset($goods_list[$index]['detail_btntext1']);
				unset($goods_list[$index]['detail_btnurl1']);
				unset($goods_list[$index]['detail_btntext2']);
				unset($goods_list[$index]['detail_btnurl2']);
				unset($goods_list[$index]['detail_totaltitle']);
				unset($goods_list[$index]['saleupdate']);
				unset($goods_list[$index]['deduct']);
				unset($goods_list[$index]['deduct2']);
				unset($goods_list[$index]['ednum']);
				unset($goods_list[$index]['edmoney']);
				unset($goods_list[$index]['edareas']);
				unset($goods_list[$index]['diyformtype']);
				unset($goods_list[$index]['diyformid']);
				unset($goods_list[$index]['diymode']);
				unset($goods_list[$index]['dispatchtype']);
				unset($goods_list[$index]['dispatchid']);
				unset($goods_list[$index]['dispatchprice']);
				unset($goods_list[$index]['manydeduct']);
				unset($goods_list[$index]['cates']);
				unset($goods_list[$index]['erpid']);
				unset($goods_list[$index]['erpids']);
				unset($goods_list[$index]['optionids']);
				unset($goods_list[$index]['goodscount']);
				
				
				
				
				
				unset($goods_list[$index]['weipos_prodid']);
				unset($goods_list[$index]['weipos_storeid']);
				unset($goods_list[$index]['isdiscount_title']);
				unset($goods_list[$index]['isdiscount_discounts']);
				unset($goods_list[$index]['commission']);
				unset($goods_list[$index]['shopid']);
				unset($goods_list[$index]['allcates']);
				unset($goods_list[$index]['minbuy']);
				unset($goods_list[$index]['invoice']);
				unset($goods_list[$index]['repair']);
				unset($goods_list[$index]['seven']);
				unset($goods_list[$index]['money']);
				unset($goods_list[$index]['maxprice']);
				unset($goods_list[$index]['province']);
				unset($goods_list[$index]['city']);
				unset($goods_list[$index]['buyshow']);
				unset($goods_list[$index]['buycontent']);
				unset($goods_list[$index]['virtualsend']);
				unset($goods_list[$index]['virtualsendcontent']);
				unset($goods_list[$index]['verifytype']);
				unset($goods_list[$index]['diyfields']);
				unset($goods_list[$index]['diysaveid']);
				unset($goods_list[$index]['diysave']);
				unset($goods_list[$index]['quality']);
				unset($goods_list[$index]['groupstype']);
				unset($goods_list[$index]['showtotal']);
				unset($goods_list[$index]['subtitle']);
				unset($goods_list[$index]['sharebtn']);
				unset($goods_list[$index]['merchid']);
				unset($goods_list[$index]['check']);
				unset($goods_list[$index]['minpriceupdated']);
				unset($goods_list[$index]['catesinit3']);
				unset($goods_list[$index]['showtotaladd']);
				unset($goods_list[$index]['thumb_first']);
				unset($goods_list[$index]['merchsale']);
				unset($goods_list[$index]['keywords']);
				unset($goods_list[$index]['catch_id']);
				unset($goods_list[$index]['catch_url']);
				unset($goods_list[$index]['catch_source']);
				unset($goods_list[$index]['labelname']);
				unset($goods_list[$index]['autoreceive']);
				unset($goods_list[$index]['cannotrefund']);
				unset($goods_list[$index]['bargain']);
				unset($goods_list[$index]['buyagain']);
				unset($goods_list[$index]['buyagain_islong']);
				unset($goods_list[$index]['buyagain_condition']);
				unset($goods_list[$index]['buyagain_sale']);
				unset($goods_list[$index]['buyagain_commission']);
				unset($goods_list[$index]['diypage']);
				unset($goods_list[$index]['cashier']);
				unset($goods_list[$index]['seckill']);
				unset($goods_list[$index]['seckill_taskid']);
				unset($goods_list[$index]['seckill_roomid']);
				unset($goods_list[$index]['seckill_timeid']);
				unset($goods_list[$index]['issendtime']);
				unset($goods_list[$index]['usetime']);
				unset($goods_list[$index]['endtime']);
				unset($goods_list[$index]['merchdisplayorder']);
				unset($goods_list[$index]['exchange_stock']);
				unset($goods_list[$index]['exchange_postage']);
				unset($goods_list[$index]['presellprice']);
				unset($goods_list[$index]['presellover']);
				unset($goods_list[$index]['presellovertime']);
				unset($goods_list[$index]['presellstart']);
				unset($goods_list[$index]['preselltimestart']);
				unset($goods_list[$index]['presellend']);
				unset($goods_list[$index]['preselltimeend']);
				unset($goods_list[$index]['presellsendtype']);
				unset($goods_list[$index]['presellsendstatrttime']);
				unset($goods_list[$index]['presellsendtime']);
				unset($goods_list[$index]['isstatustime']);
				unset($goods_list[$index]['statustimestart']);
				unset($goods_list[$index]['statustimeend']);
				unset($goods_list[$index]['showsales']);
				unset($goods_list[$index]['supplierid']);
				if ($item['total'] < 1) {
	...
	public function get_detail()
	{
		...
		$showgoods = 0;
		$changeCredit=$goods['credit'];
		$Marketprice=$goods['marketprice'];
		if(preg_match('/([\d]*)%/',$changeCredit)){
				$val = intval($changeCredit);
				$resCredit =$Marketprice * $val/100 ;
			}else if(preg_match('/[\d]*/',$changeCredit)){
				$resCredit= intval($changeCredit);
			}
		if (!empty($member)) {
		...
		public function get_category()
	{
		...
		app_json(array('allcategory' => $allcategory, 'catlevel' => $catlevel, 'opencategory' => $opencategory, 'brands' => $bs));
	}
	public function get_floor()
	{
		...
		if(!empty($allcategory)){
			...
			foreach ($parent as $key=>$value){
				$item  = array();
				$item['id']=$value['id'];
				$item['uniacid']=$value['uniacid'];
				$item['name']=$value['name'];
				$item['advimg']=$_W['siteroot'].'attachment/'.$value['advimg'];
				$item['level']=$value['level'];
				$item['goods']=array();
				$cateid[$value['id']] = $item;
			}
			$cateStr = '';
			foreach ($parent as $key=>$value) {
				$cateStr .= ','.$value['id'];
			}
			$cateStr = '('.substr($cateStr, 1).')';
			$sql='select id,title,thumb,unit,marketprice,pcate from'.tablename('ewei_shop_goods').'where pcate in '.$cateStr;
			$goods=pdo_fetchall($sql);
			$goods = set_medias($goods, 'thumb');
			foreach($goods as $akey=>$avalue){
				array_push($cateid[$avalue['pcate']]['goods'], $avalue);
			}
			app_json(array('floors'=>$cateid));
		}
	}
}
